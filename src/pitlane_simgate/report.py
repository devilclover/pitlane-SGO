...
from .models import GateDecision, RunResult
from .utils import BLACK, PIT_RED, WHITE, json_dump
...
def write_report(
    results: list[RunResult], decision: GateDecision, out_json: str, out_html: str
) -> None:
